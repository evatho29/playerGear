...
//
// NOTE: Added a global pollen multiplier for "tools" so they give 300x pollen.
// Adjusting individual tool multipliers below multiplies the original factor by POLLEN_MULT.
// If you want a different multiplier, change POLLEN_MULT here.
//
const POLLEN_MULT = 300;
    ...
    mask:{
        ...
        helmet:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=(1.15 * POLLEN_MULT)
                stats.whitePollen*=(1.15 * POLLEN_MULT)
                stats.redPollen*=(1.15 * POLLEN_MULT)
                stats.defense+=0.1
        ...
        propellerHat:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=(1.2 * POLLEN_MULT)
                stats.whitePollen*=(1.2 * POLLEN_MULT)
                stats.redPollen*=(1.2 * POLLEN_MULT)
                stats.jumpPower*=1.1
        ...
        beekeeperMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=(1.25 * POLLEN_MULT)
                stats.whitePollen*=(1.25 * POLLEN_MULT)
                stats.redPollen*=(1.25 * POLLEN_MULT)
                stats.pollenFromBees*=(1.22 * POLLEN_MULT)
                stats.defense+=0.25
        ...
        honeyMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=(1.4 * POLLEN_MULT)
                stats.whitePollen*=(1.4 * POLLEN_MULT)
                stats.redPollen*=(1.4 * POLLEN_MULT)
                stats.pollenFromBees*=(1.35 * POLLEN_MULT)
                stats.defense+=0.3
        ...
        fireMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.capacityMultiplier*=1.75
                stats.redPollen*=(1.6 * POLLEN_MULT)
        ...
        gummyMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=(1.35 * POLLEN_MULT)
                stats.whitePollen*=(1.35 * POLLEN_MULT)
                stats.redPollen*=(1.35 * POLLEN_MULT)
                // extra whitePollen factor in original code - preserve multiplicative behavior but scale both factors
                stats.whitePollen*=(1.5 * POLLEN_MULT)
                stats.honeyFromTokens*=1.5
        ...
        diamondMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=(1.5 * POLLEN_MULT)
                // duplicate bluePollen multiply in original — keep both scaled
                stats.bluePollen*=(1.35 * POLLEN_MULT)
                stats.whitePollen*=(1.35 * POLLEN_MULT)
                stats.redPollen*=(1.35 * POLLEN_MULT)
                stats.convertRate*=2
        ...
        demonMask:{
            ...
            applyStats:function(stats,player){
                ...
                stats.redPollen*=(1.75 * POLLEN_MULT)
                stats.beeAttack*=1.25
                stats.instantFlameConversion=window.applyPercentage(stats.instantFlameConversion,0.5)
                stats.flamePollen*=(2 * POLLEN_MULT)
                stats.redBeeAbilityRate*=1.2
                stats.blueBeeAbilityRate*=1.2
                stats.whiteBeeAbilityRate*=1.2
                stats.defense+=0.35
    ...
    belt:{
        ...
        honeycombBelt:{
            ...
            applyStats:function(stats,player){
                ...
                stats.honeyFromTokens*=1.5
                stats.whiteBeeAttack++
                stats.whiteBombPollen*=(1.3 * POLLEN_MULT)
        ...
        petalBelt:{
            ...
            applyStats:function(stats,player){
                ...
                stats.whiteBombPollen*=(1.5 * POLLEN_MULT)
    ...
    backpack:{
        ...
        canister:{
            ...
            mesh:function(box,cylinder,sphere){
                ...
                cylinder(0.2,-0.1,-0.6,0.4,0.5,11,1.3,1.3,1.3,90,0,0)
                cylinder(-0.2,-0.1,-0.6,0.4,0.5,11,1.3,1.3,1.3,90,0,0)
                sphere(0.2,-0.1+0.9*0.5,-0.6,0.2*2,2,1.25,1.25,1.25)
                sphere(-0.2,-0.1+0.9*0.5,-0.6,0.2*2,2,1.25,1.25,1.25)
        ...
        redPortOHive:{
            ...
            applyStats:function(stats,player){
                ...
                stats.redPollen*=(1.1 * POLLEN_MULT)
        ...
        bluePortOHive:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=(1.1 * POLLEN_MULT)
        ...
        coconutCanister:{
            ...
            applyStats:function(stats,player){
                ...
                // original also had an extra instantWhiteConversion adjustment; preserve it (scaled)
                stats.instantWhiteConversion=window.applyPercentage(stats.instantWhiteConversion,0.1)
                stats.whitePollen*=(1.25 * POLLEN_MULT)
                // duplicate whitePollen in original - preserve multiplicative behavior scaled
                stats.whitePollen*=(1.25 * POLLEN_MULT)
                stats.redPollen*=(1.25 * POLLEN_MULT)
                stats.bluePollen*=(1.25 * POLLEN_MULT)
                stats.whiteBeeAttack+=2
    ...
    boots:{
        ...
        gummyBoots:{
            ...
            applyStats:function(stats,player){
                ...
                stats.walkSpeed*=1.2
                stats.jumpPower*=1.4
                stats.pollenFromCoconuts*=(2 * POLLEN_MULT)
                stats.goo*=1.25
                stats.beeSpeed*=1.3
                stats.honeyFromTokens*=1.25
                stats.redPollen*=(1.1 * POLLEN_MULT)
                stats.bluePollen*=(1.1 * POLLEN_MULT)
                stats.whitePollen*=(1.1 * POLLEN_MULT)
                stats.beeAttack*=1.1
                stats.convertRateAtHive*=2
        ...
        mondoBoots:{
            ...
            applyStats:function(stats,player){
                ...
                stats.pollenFromBees*=(1.25 * POLLEN_MULT)
                stats.beeSpeed*=1.2
            },
    ...
    leftGuard:{
        ...
        bomberGuard:{
            ...
            applyStats:function(stats,player){
                ...
                stats.capacity+=15000
                stats.whitePollen*=(1.1 * POLLEN_MULT)
                stats.whiteBombPollen*=(1.15 * POLLEN_MULT)
                stats.redBombPollen*=(1.15 * POLLEN_MULT)
                stats.blueBombPollen*=(1.15 * POLLEN_MULT)
            },
        ...
        crimsonGuard:{
            ...
            applyStats:function(stats,player){
                ...
                stats.capacity+=300000
                stats.instantRedConversion=window.applyPercentage(stats.instantRedConversion,0.2)
                stats.redBombPollen*=(1.5 * POLLEN_MULT)
    ...
    rightGuard:{
        ...
        cobaltGuard:{
            ...
            applyStats:function(stats,player){
                ...
                stats.bluePollen*=(1.35 * POLLEN_MULT)
                stats.instantBlueConversion=window.applyPercentage(stats.instantBlueConversion,0.2)
                stats.blueBombPollen*=(1.5 * POLLEN_MULT)
